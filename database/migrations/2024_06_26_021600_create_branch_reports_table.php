...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('branch_reports', function (Blueprint $table) {
            ...
            $table->foreignId('branch_raw_materials_report_id')->references('id')->on('branch_raw_materials_reports');
            $table->foreignId('expences_report_id')->references('id')->on('expences_reports');
            $table->timestamps();
        });
    }
